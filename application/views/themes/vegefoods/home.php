...
<section id="home-section" class="hero">
  <div class="home-slider owl-carousel">
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bghero.jpg'); ?>);">
      <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2"> di website beautywellness.co</h1>
            <h2 class="subheading mb-4">Kesehatan dan Kecantikan</h2>
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bg-4.jpg'); ?>);">
      <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">100% Produk asli</h1>
            <h2 class="subheading mb-4">Perawatan yang baik adalah investasi dalam kesehatan, bukan hanya tampilan</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
          </div>
      ...
      <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
        <div class="media block-6 services mb-md-0 mb-4">
          <div class="icon bg-color-2 d-flex justify-content-center align-items-center mb-2">
            <span class="icons ion-ios-wallet"></span>
          </div>
          <div class="media-body">
            <h3 class="heading">Pembayaran</h3>
            <span>Pembayaran digital atau cash </span>
          </div>
        </div>
      </div>
      <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
        <div class="media block-6 services mb-md-0 mb-4">
          <div class="icon bg-color-3 d-flex justify-content-center align-items-center mb-2">
            <span class="icons ion-ios-trophy"></span>
          </div>
          <div class="media-body">
...
<section class="ftco-section img" style="background-image: url(<?php echo get_theme_uri('images/bg-4.jpg'); ?>);">
  <div class="container">
